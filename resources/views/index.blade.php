...
<head>
  <meta charset="utf-8">
  <title>Antrian Layanan | BPOM Mamuju</title>
  ...
  <div class="container">
    <div class="row mt-3">
      ...
      <div class="col-10 mt-4 text-center">
        <h2 class="mb-1 ">Registrasi Antrian BPOM Mamuju</h2>
        <h4 class=" mb-4">Silahkan login atau daftar untuk mengambil antrian</h4>
      </div>
    </div>
  </div>
  <div class="scroll-left mt-5">
    <p class="fw-bold">Follow Sosial media kami : Instagram : @bpom.mamuju X:@bpommamuju Facebook:@bpom.mamuju YouTube:@balaipomdimamuju</p>
  </div>
  <!-- background shapes -->
  <!-- <div id="scene">
...
<!-- pricing -->
<section class="section-lg pricing" id="pricing">
  <div class="container">
    <div class="row">
      <!-- <div class="col">
...
<footer class="footer-section footer" style="background-image: url(images/backgrounds/footer-bg.png);">
  <div class="container">
    <div class="row">
      <div class="col text-center text-lg-left mb-lg-0">
        <!-- <a href="index.html">
          <img class="img-fluid" src="images/logo.png" alt="logo">
        </a> -->
        <p class="text-center"> Copyright &copy BPOM Mamuju 2025</p>
      </div>
